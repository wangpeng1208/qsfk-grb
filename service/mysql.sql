...
CREATE TABLE `admin_menu` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='用户快捷菜单';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `admin_user` VALUES (1,'admin','超级管理员','$2y$10$k1E.ibagjmP45hvfAy2TcuIMmikMkbLDB.e7MVITAvsWD6KMtkNrC','https://demo.qqss.net/static/common/images/noavatar.png','990504246@qq.com',NULL,'2023-04-29 17:09:09','2024-02-18 15:16:51','2024-02-18 15:16:51',1);
...
CREATE TABLE `goods_category` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='商品栏目表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `system_uploads` (
  ...
  `user_id` int(11) DEFAULT NULL COMMENT '图片所属人',
  `user_type` varchar(50) NOT NULL DEFAULT 'admin' COMMENT '图片所属应用admin merchant personal',
...
-- Dump completed on 2024-10-12  2:56:08
