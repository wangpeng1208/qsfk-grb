<template>
  <t-card title="支付渠道分析" class="basic-container" :bordered="false">
    ...
    <t-base-table class="basic-table" :data="lists" :columns="columns" row-key="id" vertical-align="middle" :hover="lists.length > 0 ? true : false" :pagination="pagination" :header-affixed-top="headerAffixedTop" table-layout="auto" max-height="100%" @page-change="rehandlePageChange">
      <template #empty>
