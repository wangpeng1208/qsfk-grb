<template>
  <t-row :gutter="{ xs: 8, sm: 16, md: 20, lg: 20, xl: 20, xxl: 20 }">
    <t-col :span="6">
      <t-card title="销售额" header-bordered hover-shadow :bordered="false"
        style="border-top: var(--td-brand-color) solid 3px;">
        <template #title>
          <t-tooltip content="点击进入订单列表面板">
            <div @click="goPage('/admin/order/list')" style="cursor: pointer;">
              销售额统计
            </div>
          </t-tooltip>
        </template>
        ...
        <div style="padding-top: var(--td-comp-paddingTB-l);">
          <div style="display: flex;justify-content: space-between;padding-bottom:5px">
            ...
            <div style="display: flex; justify-content: center;">
              <div>
                <t-icon v-if="price.today > price.yesterday" name="arrow-triangle-up-filled"
                  style="color: #d54941; font-size: var(--td-font-size-body-large)" />
                <t-icon v-else name="arrow-triangle-down-filled"
    ...
    <t-col :span="6">
      <t-card title="订单数" header-bordered hover-shadow :bordered="false"
        style="border-top: rgb(159, 219, 29) solid 3px;">
        <template #title>
        ...
        <div style="padding-top: var(--td-comp-paddingTB-l);">
          <div style="display: flex;justify-content: space-between;padding-bottom:5px">
            ...
            <div style="display: flex; justify-content: center;">
              <div>
                <t-icon v-if="order.today > order.yesterday" name="arrow-triangle-up-filled"
                  style="color: #d54941; font-size: var(--td-font-size-body-large)" />
                <t-icon v-else name="arrow-triangle-down-filled"
                  style="color: #2ba471; font-size: var(--td-font-size-body-large)" />
                {{ order.yesterday }} 笔
