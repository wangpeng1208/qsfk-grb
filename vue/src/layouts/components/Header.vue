<template>
  <div :class="layoutCls">
    <t-head-menu :class="menuCls" :theme="menuTheme" expand-type="popup" :value="active">
      <template #logo>
        <span v-if="showLogo" class="header-logo-container" @click="handleNav('/admin/workbench')">
          <img :src="siteLogo" alt="" style="width: 160px; height: 50px" />
        </span>
      </template>
        ...
        <div class="operations-container">
          ...
          <t-tooltip placement="bottom" content="全屏">
            <t-button theme="default" shape="square" variant="text" @click="toggleFullScreen">
              <t-icon name="fullscreen" size="large" />
            </t-button>
          </t-tooltip>
          <t-divider layout="vertical" />
    ...
    return [
      {
        ...
        [`${prefix}-header-menu-fixed-side-compact`]: false,
      },
    ];
  }
  return [
